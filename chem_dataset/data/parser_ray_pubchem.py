...
def convert_molecule(molecule: Union[MoleculeContainer, str]) -> Optional[MoleculeContainer]:
    """
    It takes a molecule and returns a standardized version of that molecule
    
    :param molecule: The molecule to be standardized. Can be a string or a MoleculeContainer object
    :type molecule: Union[MoleculeContainer, str]
    :return: A standardized molecule
    """
...
def process_batch(molecules: List[Union[MoleculeContainer, str]]) -> List[Optional[MoleculeContainer]]:
    """
    We take a list of molecules, put them in the object store, and then call the `convert_molecule`
    function on each of them
    
    :param molecules: List[Union[MoleculeContainer, str]]
    :type molecules: List[Union[MoleculeContainer, str]]
    :return: A list of MoleculeContainer objects.
    """
